...
import com.yongyong.vredact.filter.CameraFilter;
...
import com.yongyong.vredact.record.TextureMovieEncoder;
 ...
 */
public class VRCameraDrawer implements GLSurfaceView.Renderer {
    ...
    public VRCameraDrawer(Resources resources){
        //初始化一个滤镜 也可以叫控制器
...
//        showFilter.setTextureId(textureID);
    ...
    public void onDrawFrame(GL10 gl10) {
        ...
        mBeFilter.draw();
        if (mBeautyFilter != null && mBeautyFilter.getBeautyLevel().getLevel() != 0){
            EasyGlUtils.bindFrameTexture(fFrame[0],fTexture[0]);
            GLES20.glViewport(0,0,mPreviewWidth,mPreviewHeight);
    ...
    /**提供修改美白等级的接口*/
    public void changeBeautyLevel(VRBeautifyLevel level){
