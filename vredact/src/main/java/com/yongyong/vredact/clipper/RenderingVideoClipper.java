...
import com.yongyong.vredact.filter.MagicFilterFactory;
...
public class RenderingVideoClipper {
    ...
    int videoHeight;
    int videoRotation;
    RenderingOutputSurface outputSurface = null;
    ...
    public void clipVideo(long startPosition, long clipDur, ArrayList<VideoRecordCutBaseView> views, Resources resources) throws IOException {
        mViews = views;
    ...
    private void initVideoCodec() {
        ...
        outputSurface = new RenderingOutputSurface(info,mViews,mResources);
    ...
    private void startVideoCodec(MediaCodec decoder, MediaCodec encoder, MediaExtractor extractor, InputSurface inputSurface, RenderingOutputSurface outputSurface, long firstSampleTime, long startPosition, long duration) {
        ByteBuffer[] decoderInputBuffers = decoder.getInputBuffers();
        ByteBuffer[] encoderOutputBuffers = encoder.getOutputBuffers();
        MediaCodec.BufferInfo info = new MediaCodec.BufferInfo();
        MediaCodec.BufferInfo outputInfo = new MediaCodec.BufferInfo();
