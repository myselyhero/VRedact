 ...
 * 水印的Filter
 */
public class RenderingWaterMarkFilter extends NoFilter {
    private int x,y,w,h;
    ...
    public RenderingWaterMarkFilter(Resources mRes) {
        super(mRes);
    ...
    public RenderingWaterMarkFilter(Resources res, boolean isGif, int bitRes, float rotateDegree) {
        super(res);
        mResources = res;
        mGifId = bitRes;
        mIsGif = isGif;
