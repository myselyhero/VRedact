...
import com.yongyong.vredact.filter.AFilter;
...
class TextureRender {
    ...
    public TextureRender(VideoInfo info) {
        ...
        mShow = new NoFilter(VRKit.getAppContext().getResources());
        mShow.setMatrix(MatrixUtils.flip(MatrixUtils.getOriginalMatrix(), false, true));
        rotationFilter = new RotationOESFilter(VRKit.getAppContext().getResources());
    }
...
//        st.getTransformMatrix(mSTMatrix);//当视频角度不为0时,这里会导致视频方向不对
    ...
    public void surfaceCreated() {
        ...
        if(!isClipMode){
            ...
            switch (curMode){
                case VRConstants.MODE_POR_9_16:
                    clipViewWidth=VRConstants.mode_por_width_9_16;
                    clipViewHeight=VRConstants.mode_por_height_9_16;
                    clipEncodeWidth=VRConstants.mode_por_encode_width_9_16;
                    clipEncodeHeight=VRConstants.mode_por_encode_height_9_16;
                    break;
                case VRConstants.MODE_POR_1_1:
                    clipViewWidth=VRConstants.mode_por_width_1_1;
                    clipViewHeight=VRConstants.mode_por_height_1_1;
                    clipEncodeWidth=VRConstants.mode_por_encode_width_1_1;
                    clipEncodeHeight=VRConstants.mode_por_encode_height_1_1;
                    break;
                case VRConstants.MODE_POR_16_9:
                    clipViewWidth=VRConstants.mode_por_width_16_9;
                    clipViewHeight=VRConstants.mode_por_height_16_9;
                    clipEncodeWidth=VRConstants.mode_por_encode_width_16_9;
                    clipEncodeHeight=VRConstants.mode_por_encode_height_16_9;
                    break;
            }
