...
public class MagicBrooklynFilter extends GPUImageFilter{
	...
	public void onInitialized(){
	    ...
	    runOnDraw(new Runnable(){
		    public void run(){
		    	inputTextureHandles[0] = OpenGlUtils.loadTexture(VRKit.getAppContext(), "filter/brooklynCurves1.png");
				inputTextureHandles[1] = OpenGlUtils.loadTexture(VRKit.getAppContext(), "filter/filter_map_first.png");
				inputTextureHandles[2] = OpenGlUtils.loadTexture(VRKit.getAppContext(), "filter/brooklynCurves2.png");
		    }
	    });
	}
}
