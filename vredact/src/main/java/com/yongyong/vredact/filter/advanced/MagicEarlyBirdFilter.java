...
public class MagicEarlyBirdFilter extends GPUImageFilter {
	...
	protected void onInitialized(){
	    ...
	    runOnDraw(new Runnable(){
		    public void run(){
		    	inputTextureHandles[0] = OpenGlUtils.loadTexture(VRKit.getAppContext(), "filter/earlybirdcurves.png");
				inputTextureHandles[1] = OpenGlUtils.loadTexture(VRKit.getAppContext(), "filter/earlybirdoverlaymap_new.png");
				inputTextureHandles[2] = OpenGlUtils.loadTexture(VRKit.getAppContext(), "filter/vignettemap_new.png");
				inputTextureHandles[3] = OpenGlUtils.loadTexture(VRKit.getAppContext(), "filter/earlybirdblowout.png");
				inputTextureHandles[4] = OpenGlUtils.loadTexture(VRKit.getAppContext(), "filter/earlybirdmap.png");
		    }
	    });
	}
}
