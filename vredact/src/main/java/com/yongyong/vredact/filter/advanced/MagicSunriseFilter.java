	...
	public void onInitialized(){
	    ...
	    runOnDraw(new Runnable(){
		    public void run(){
		        ...
		        GLES20.glActiveTexture(GLES20.GL_TEXTURE4);
		        mMaskGrey1TextureId = OpenGlUtils.loadTexture(VRKit.getAppContext(), "filter/amaro_mask1.jpg");
		        GLES20.glActiveTexture(GLES20.GL_TEXTURE5);
		        mMaskGrey2TextureId = OpenGlUtils.loadTexture(VRKit.getAppContext(), "filter/amaro_mask2.jpg");
		        GLES20.glActiveTexture(GLES20.GL_TEXTURE6);
		        mMaskGrey3TextureId = OpenGlUtils.loadTexture(VRKit.getAppContext(), "filter/toy_mask1.jpg");
		    }
	    });
	}
}
