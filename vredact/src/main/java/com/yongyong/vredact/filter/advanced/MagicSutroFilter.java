...
public class MagicSutroFilter extends GPUImageFilter{
	...
	public void onInitialized(){
	    ...
	    runOnDraw(new Runnable(){
		    public void run(){
		    	inputTextureHandles[0] = OpenGlUtils.loadTexture(VRKit.getAppContext(), "filter/vignette_map.png");
				inputTextureHandles[1] = OpenGlUtils.loadTexture(VRKit.getAppContext(), "filter/sutrometal.png");
				inputTextureHandles[2] = OpenGlUtils.loadTexture(VRKit.getAppContext(), "filter/softlight.png");
				inputTextureHandles[3] = OpenGlUtils.loadTexture(VRKit.getAppContext(), "filter/sutroedgeburn.png");
				inputTextureHandles[4] = OpenGlUtils.loadTexture(VRKit.getAppContext(), "filter/sutrocurves.png");
		    }
	    });
	}
}