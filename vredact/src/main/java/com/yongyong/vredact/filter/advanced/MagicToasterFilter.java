...
public class MagicToasterFilter extends GPUImageFilter{
	...
	public void onInitialized(){
	    ...
	    runOnDraw(new Runnable(){
		    public void run(){
		    	inputTextureHandles[0] = OpenGlUtils.loadTexture(VRKit.getAppContext(), "filter/toastermetal.png");
				inputTextureHandles[1] = OpenGlUtils.loadTexture(VRKit.getAppContext(), "filter/toastersoftlight.png");
				inputTextureHandles[2] = OpenGlUtils.loadTexture(VRKit.getAppContext(), "filter/toastercurves.png");
				inputTextureHandles[3] = OpenGlUtils.loadTexture(VRKit.getAppContext(), "filter/toasteroverlaymapwarm.png");
				inputTextureHandles[4] = OpenGlUtils.loadTexture(VRKit.getAppContext(), "filter/toastercolorshift.png");
		    }
	    });
	}
}
