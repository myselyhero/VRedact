...
public class MagicXproIIFilter extends GPUImageFilter{
	...
	public void onInitialized(){
		...
		runOnDraw(new Runnable(){
			public void run(){
				inputTextureHandles[0] = OpenGlUtils.loadTexture(VRKit.getAppContext(), "filter/xpromap.png");
				inputTextureHandles[1] = OpenGlUtils.loadTexture(VRKit.getAppContext(), "filter/vignettemap_new.png");
			}
		});
	}
