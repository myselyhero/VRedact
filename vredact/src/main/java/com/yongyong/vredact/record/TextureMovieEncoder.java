...
package com.yongyong.vredact.record;
...
import com.yongyong.vredact.filter.base.MagicCameraInputFilter;
...
//    private MagicFilterType type = MagicFilterType.NONE;
    private AFilter mShowFilter=new NoFilter(VRKit.getAppContext().getResources());
