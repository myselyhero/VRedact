 ...
 * @// TODO: 2020/9/11
 */
public class VideoRecordCutBaseView extends AppCompatImageView {
    ...
    public VideoRecordCutBaseView(Context context) {
        super(context);
        initData();
    }


    public VideoRecordCutBaseView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initData();
    }

    public VideoRecordCutBaseView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
